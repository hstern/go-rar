module github.com/hstern/go-rar/example/fosite-handler

go 1.26

require (
	github.com/hstern/go-rar v0.1.0
...
// `cd example/fosite-handler && go run .` works straight after a clone
// without an intermediate publish step.
